...
export const RadiusProCustomizer: React.FC<RadiusProCustomizerProps> = ({ 
  ...
  const handleAddToCart = useCallback(async () => {
    ...
    console.log('🎯 Radius Pro: Using unified cart utility');
    ...
    try {
      // Calculate quantity from price using the $1 hack
      ...
      // Build visible part breakdown as separate properties for cart display
      ...
      if (cartError instanceof Error) {
        ...
        if (cartError.message.includes('422') || cartError.message.includes('variant')) {
          errorMessage += '\n\n🔧 Tip: Ensure the product variant exists in your Shopify store admin.';
